...
const ConfirmBookingTour = ({ navigation, params, dataItem }) => {
  ...
  const caculateTotalPrice = () => {
    ...
    if (params?.person_types && !_.isEmpty(params?.person_types)) {
      _.forEach(params?.person_types, (e) => {
...
export default React.memo(ConfirmBookingTour);
