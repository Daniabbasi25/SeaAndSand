...
const AvailableFlight = ({ type, id, navigation }) => {
  const [params, setParams] = useState(defaultParamsCheckAvailableFlight);
  ...
  return (
    <View style={styles.wrapAvailableFlight}>
      {formCondition()}
...
export default React.memo(AvailableFlight);
